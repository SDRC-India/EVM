...
//		String fileName = ResourceBundle.getBundle("spring/app").getString("biharinfo.jpgimage.path");
...
//	}
	 ...
	 public String createImgFromFile(String path, int cnt) throws Exception{
...
//		 String fileName = "D:/";
		 String fileName = ResourceBundle.getBundle("spring/app").getString("evm.jpgimage.path");
		 OutputStream ostream = new FileOutputStream(fileName+"/map_"+date+".jpg");
		 TranscoderOutput output = new TranscoderOutput(ostream);
