...
public class pageController {
	...
	public ModelAndView getAllResources() {
		...
		modelAndView.addObject("resourcesList",
				documentService.searchAllResources(3));
	...
	public ModelAndView getAllSops() {
		ModelAndView modelAndView = new ModelAndView();
		modelAndView
				.addObject("resourcesList", documentService.searchAllSop(0));
	...
	public ModelAndView getAllAssessmentTools() {
		ModelAndView modelAndView = new ModelAndView();
		modelAndView.addObject("assessmentToolsList",
				documentService.searchAllAssessmentTools(0));
		modelAndView.addObject("userGuidesList",
				documentService.searchAllUserGuides(0));
