					...
					<div class="col-sm-8">
						<div id="carousel-banner-slide" class="carousel slide"
							...
							<div class="carousel-inner">
								...
								<div class="item">
									<img alt="evm-gallry-image"
										src="resources/images/1411726656252.jpg"
										class="img-responsive">
								</div>
								<div class="item">
									<img alt="evm-gallry-image"
										src="resources/images/1419315165765.jpg"
										class="img-responsive">
								</div>
								<div class="item">
									<img alt="evm-gallry-image" src="resources/images/DSCN2493.jpg"
										class="img-responsive">
								</div>
								<div class="item">
									<img alt="evm-gallry-image" src="resources/images/DSCN2494.jpg"
										class="img-responsive">
								</div>

								<div class="item">
									<img alt="evm-gallry-image" src="resources/images/DSCN2520.jpg"
										class="img-responsive">
								</div>

								<div class="item">
									<img alt="evm-gallry-image" src="resources/images/DSCN2522.jpg"
										class="img-responsive">
								</div>

								<div class="item">
									<img alt="evm-gallry-image" src="resources/images/DSCN2545.jpg"
										class="img-responsive">
								</div>

								<div class="item">
									<img alt="evm-gallry-image" src="resources/images/DSCN2585.jpg"
										class="img-responsive">
								</div>

								<div class="item">
									<img alt="evm-gallry-image" src="resources/images/DSCN2591.jpg"
										class="img-responsive">
								</div>

								<div class="item">
									<img alt="evm-gallry-image"
										src="resources/images/DVS Darrang.jpg" class="img-responsive">
								</div>

								<div class="item">
									<img alt="evm-gallry-image"
										src="resources/images/SVS Guwahati.jpg" class="img-responsive">
								</div>
							</div>
