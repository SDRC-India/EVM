						...
						<div class="panel-group" id="accordion">
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title">
										<a class="accordion-toggle" data-toggle="collapse"
											...
											install the SDRC Collect but am unable to do so. What could be the
											reason?
										</a>
									</h4>
								</div>
								<div id="collapseTwo" class="panel-collapse collapse">
									<div class="panel-body">
										<p>Check for any instances of SDRC Collect that is
											installed on the device. If SDRC Collect is already installed,
											then you will not be able to install SDRC Collect.</p>
									</div>
								</div>
							</div>
							<div class="panel panel-default">
							...
							<div class="panel panel-default">
								...
								<div id="collapseFive" class="panel-collapse collapse">
									<div class="panel-body">
										<p>
											You can download the SDRC Collect manual (<a
												href="resources/applications/SDRC Collect_v3.pdf"
												download="resources/applications/SDRC Collect_v3.pdf"
												title="click to download SDRC Collect">SDRC Collect
												</a>) from the "Tools" section of the website. Follow
								...
								<div id="collapseEight" class="panel-collapse collapse">
									<div class="panel-body">
										<p>
											...
											the "SDRC" zipped folder with the name of the facility for
								...
								<div class="panel-heading">
									<h4 class="panel-title">
										<a class="accordion-toggle" data-toggle="collapse"
											...
											class="glyphicon glyphicon-plus"></span>Can I use the SDRC Collect
								...
								<div id="collapseTwelve" class="panel-collapse collapse">
									<div class="panel-body">
										<p>Restart the phone and check the problem still exists or
											...
											SDRC Collect and re-install it. Provide the necessary
