...
<div class="exportshare-section">
	...
	<form id="exportForm" method="post">
		...
		<input type="hidden" name="parentAreaName" value="${param.parentAreaName}" id="parentAreaName" /> 
	...
	<script>
		$(document).ready(
				function() {
					sdrc_export.export_pdf("${param.mapContainer}",
							"${param.chartContainer}", "pdfDownloadBtn");
				});
	</script>
</div>
